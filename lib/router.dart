...
import 'package:flutter_tiktok_clone/features/notification/notification_provider.dart';
...
final routerProvider = Provider(
  (ref) {
    ...
    return GoRouter(
        ...
        routes: [
          // 메인 라우터를 감싸기 위해 ShellRoute 을 사용
          ShellRoute(
            builder: (context, state, child) {
              ref.read(
                notificationProvider(context),
              ); // 여기에서 주입되는 context 는 go_router 를 가지고 있는 context
              return child;
            },
            routes: [
              GoRoute(
              ...
              GoRoute(
                ...
                builder: (context, state) {
                  ...
                  final NavigationTab byName =
                      NavigationTab.values.byName(param);
